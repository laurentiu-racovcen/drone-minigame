...
namespace implemented
{
    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.f), RADIANS(angle), right) * glm::vec4(forward, 0.f)));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.f), RADIANS(angle), glm::vec3(0, 1, 0)) * glm::vec4(forward, 0.f)));
            right = glm::normalize(glm::rotate(glm::mat4(1.f), RADIANS(angle), glm::vec3(0, 1, 0)) * glm::vec4(right, 0.f));
            up = glm::cross(right, forward);
        }
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            right = glm::normalize(glm::rotate(glm::mat4(1.0f), RADIANS(angle), forward) * glm::vec4(right, 0.0f));
